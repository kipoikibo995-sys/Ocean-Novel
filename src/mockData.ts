...
export const MOCK_PROJECTS = [
  {
    ...
    locationsCount: 5,
    lastEdited: 'today',
    premise: 'An investigator returns to an isolated coastal town haunted by drowned gods and the fifteen-year-old mystery of her sister\'s disappearance.',
  },
  {
    ...
    premise: 'When the Dragon Emperor perishes without an heir, an outcast solar knight and an exiled elven enchantress journey into the volcanic abyss to claim the mythical Sunken Crown.',
  },
  {
    ...
    premise: 'Inside the celestial observatory of the Astral Spire, a disgraced scholar and a daring shadow thief break the Seventh Cosmic Seal, waking forgotten stellar anomalies.',
  },
  {
    id: 'book-frostgate',
    ...
    premise: 'Beyond the colossal glacial ramparts of Frostgate Citadel, a clan berserker and a frost shaman race against a blood-moon eclipse that awakens primeval frost beasts.',
  },
  {
    ...
    premise: 'Beneath the burning dunes of the Great Mirage, an exile caravan warden and a sand sorcerer discover a sunken bronze necropolis holding the primordial heart of the sand goddess.',
  }
];
