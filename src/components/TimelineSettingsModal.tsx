        ...
        >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] uppercase tracking-widest text-amber-200/70">
                  Cài Đặt Lại Thông Số Dòng Thời Gian Tác Giả
                </p>
              </div>
            </div>
            <button
          ...
          <div className="p-6 flex flex-col gap-6 max-h-[80vh] overflow-y-auto">
            ...
            <div className="bg-[#F4EFE6] border border-[#E0D7C7] rounded-xl p-3.5 flex flex-col gap-1.5">
              <span className="text-[9px] font-bold uppercase tracking-wider text-stone-500">
                Live Preview // Hiển thị trên thanh tác giả
              </span>
            ...
            <div className="flex flex-col gap-2.5">
              <div className="flex items-center justify-between">
                <label className="text-xs font-bold uppercase tracking-wider text-[#4A3225] flex items-center gap-1.5">
                  ...
                  1. Writing Streak (Số ngày viết liên tục)
                </label>
              ...
              {streakMode === 'auto' ? (
                <div className="p-3 bg-stone-100/80 rounded-lg border border-stone-200 text-xs text-stone-600 flex items-center justify-between">
                  <span>
                    Tính toán tự động theo số ngày chỉnh sửa bản thảo: <strong>{autoStreak} ngày liên tục</strong>.
                  </span>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-xs font-semibold text-stone-600">Ngày liên tiếp (Days)</span>
                  </div>
                  {/* Presets */}
                  <div className="flex items-center gap-1.5 flex-wrap">
                    <span className="text-[10px] font-bold text-stone-500 uppercase mr-1">Chọn nhanh:</span>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              {timeMode === 'auto' ? (
                <div className="p-3 bg-stone-100/80 rounded-lg border border-stone-200 text-xs text-stone-600 flex items-center justify-between">
                  <span>
                    Tính theo tốc độ viết tiêu chuẩn (~900 từ/giờ): <strong>{autoHours}h {autoMinutes}m</strong>.
                  </span>
                  <span className="text-[10px] font-bold uppercase text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded">
                    Chuẩn Tốc Độ
                  </span>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    />
                    <span className="text-xs font-semibold text-stone-600">Giờ (Hours)</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <input
                      type="number"
                      ...
                      className="w-20 px-3 py-1.5 bg-white border border-stone-300 rounded-lg text-sm font-bold text-stone-800 focus:outline-none focus:border-amber-600"
                    />
                    <span className="text-xs font-semibold text-stone-600">Phút (Mins)</span>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="border-t border-[#E5E0D5] pt-4 flex flex-col gap-2">
              <span className="text-[10px] font-bold uppercase tracking-wider text-stone-500 flex items-center gap-1">
                ...
                Thống kê các bản thảo trong kho lưu trữ ({savedProjects.length} dự án)
              </span>
                ...
                {savedProjects.map((p) => (
                  ...
                  >
                    ...
                    <span className="font-mono text-[11px] font-bold text-[#8c503c]">
                      {(p.currentWords || 0).toLocaleString()} từ
                    </span>
                  </div>
                ))}
              </div>
          ...
          <div className="bg-[#F4EFE6] px-6 py-3.5 border-t border-[#E5E0D5] flex items-center justify-between">
            <button
              ...
              className="text-xs font-bold text-stone-600 hover:text-stone-900 flex items-center gap-1.5 py-1.5 px-2.5 rounded hover:bg-stone-200/60 transition-colors"
            >
              <RotateCcw className="w-3.5 h-3.5" />
              Đặt lại theo Timeline
            </button>
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={onClose}
                className="text-xs font-bold text-stone-600 hover:text-stone-800 px-4 py-2 rounded-lg border border-stone-300 hover:bg-white transition-colors"
              >
                Huỷ
              </button>
              <button
                type="button"
                onClick={handleSave}
                className="text-xs font-bold text-[#FCFAF5] bg-[#8c503c] hover:bg-[#a6624c] px-5 py-2 rounded-lg shadow-sm flex items-center gap-1.5 transition-colors border border-[#4a3225]"
              >
