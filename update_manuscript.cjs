...
<p>The coordinates in the journal led them far inland, away from the coastal fog and into a jagged, unforgiving landscape. The <span data-type="mention" data-id="4" class="mention">@Volcanic Citadel</span> stood as a brutal monument of black obsidian and basalt, built directly into the side of a semi-active volcano. The ambient heat was suffocating, the air thick with the smell of sulfur and ash. <span data-type="mention" data-id="1" class="mention">@Sarah Cole</span> wiped a mixture of sweat and soot from her forehead, her boots crunching against the porous volcanic rock as they climbed the ancient, uneven steps.</p>
<p>"If she came here," <span data-type="mention" data-id="2" class="mention">@Daniel Reeves</span> said, pausing to catch his breath and leaning heavily against a stone pillar, "she was tracking something massive. This place is supposed to be restricted by the federal government. A seismic monitoring zone."</p>
